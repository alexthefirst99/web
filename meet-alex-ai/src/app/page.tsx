...
export default function App() {
  ...
  return (
    <div className="w-full h-[100dvh] bg-[#05070a] overflow-hidden relative text-white">
      ...
      {/* UI Overlay */}
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col p-4 md:p-6 gap-3">
        {/* Header */}
        ...
        <div className="flex flex-col md:flex-row flex-1 md:items-center gap-3 md:gap-8 min-h-0 w-full overflow-hidden">
        ...
        {/* Bottom bar — input always visible */}
        <div className="pointer-events-auto space-y-2 max-w-xl mx-auto w-full mt-auto md:mt-0 flex-shrink-0">
